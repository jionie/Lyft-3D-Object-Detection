...
if __name__ == "__main__":
    create_nuscenes_infos(root_path='/media/jionie/my_disk/Kaggle/Lyft/input/3d-object-detection-for-autonomous-vehicles/train_data', \
        target_path='/media/jionie/my_disk/Kaggle/Lyft/input/3d-object-detection-for-autonomous-vehicles', version="lyft-trainval", max_sweeps=10)