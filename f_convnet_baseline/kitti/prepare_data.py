...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_dir', action='store_true',
                        help='data directory for kitti data root')
    ...
    if args.gen_train:
        extract_frustum_data(
            os.path.join(args.root_dir, 'train_kitti.txt'),
            'training',
    ...
    if args.gen_val:
        extract_frustum_data(
            os.path.join(BASE_DIR, 'val_kitti.txt'),
            'training',
