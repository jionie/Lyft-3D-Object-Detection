...
class MyLyftDataset(Dataset):
    ...
    def __init__(self,
                 root_path,
                 info_path,
                 class_names=["car", "motorcycle", "bus", "bicycle", "truck", "pedestrian", "other_vehicle", "animal", "emergency_vehicle"],
                 prep_func=None,
...
@register_dataset
class MyLyftDatasetD8(MyLyftDataset):
...
@register_dataset
class MyLyftDatasetD8Velo(MyLyftDatasetD8):
...
@register_dataset
class MyLyftDatasetVelo(MyLyftDataset):
    def __init__(self, *args, **kw):
        super().__init__(*args, **kw)
        self._with_velocity = True
...
@register_dataset
class MyLyftDatasetD7(MyLyftDataset):
    def __init__(self, *args, **kw):
        super().__init__(*args, **kw)
        if len(self._nusc_infos) > 28000:
            self._nusc_infos = list(
...
@register_dataset
class MyLyftDatasetD6(MyLyftDataset):
    def __init__(self, *args, **kw):
        super().__init__(*args, **kw)
        if len(self._nusc_infos) > 28000:
            self._nusc_infos = list(
...
@register_dataset
class MyLyftDatasetD5(MyLyftDataset):
    def __init__(self, *args, **kw):
        super().__init__(*args, **kw)
        if len(self._nusc_infos) > 28000:
            self._nusc_infos = list(
...
@register_dataset
class MyLyftDatasetD4(MyLyftDataset):
    def __init__(self, *args, **kw):
        super().__init__(*args, **kw)
        if len(self._nusc_infos) > 28000:
            self._nusc_infos = list(
...
@register_dataset
class MyLyftDatasetD3(MyLyftDataset):
    def __init__(self, *args, **kw):
        super().__init__(*args, **kw)
        if len(self._nusc_infos) > 28000:
            self._nusc_infos = list(
...
@register_dataset
class MyLyftDatasetD2(MyLyftDataset):
    def __init__(self, *args, **kw):
        super().__init__(*args, **kw)
        if len(self._nusc_infos) > 28000:
            self._nusc_infos = list(
...
@register_dataset
class MyLyftDatasetD2Velo(MyLyftDatasetD2):
    def __init__(self, *args, **kw):
        super().__init__(*args, **kw)
        self._with_velocity = True
...
def get_all_box_mean(info_path):
    res = {}
    details = {}
    for k in ["car", "motorcycle", "bus", "bicycle", "truck", "pedestrian", "other_vehicle", "animal", "emergency_vehicle"]:
