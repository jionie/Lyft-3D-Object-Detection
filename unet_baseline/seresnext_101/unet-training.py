...
def unet_training(train_data_folder = "/media/jionie/my_disk/Kaggle/Lyft/input/3d-object-detection-for-autonomous-vehicles/train_root/bev_data/", 
    ...
    def get_unet_model(model_name="efficientnet-b3", IN_CHANNEL=3, NUM_CLASSES=2, SIZE=336):
    ...
    ############################################################################### model and optimizer
    model = get_unet_model(model_name=model_name, IN_CHANNEL=3, NUM_CLASSES=len(classes)+1, SIZE=SIZE)
...
if __name__ == "__main__":
    unet_training(model_name = "seresnext101")
