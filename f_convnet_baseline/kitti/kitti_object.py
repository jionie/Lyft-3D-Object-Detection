...
sys.path.append("/media/jionie/my_disk/Kaggle/Lyft/input/3d-object-detection-for-autonomous-vehicles")
...
class kitti_object(object):
    ...
    def __init__(self, root_dir, split='training'):
        ...
        if split == 'training':
            self.num_samples = 136074
            self.split_dir = os.path.join(root_dir, 'train_root/kitti')
            self.image_dir = os.path.join(self.split_dir, 'image_2')
            self.calib_dir = os.path.join(self.split_dir, 'calib')
            self.lidar_dir = os.path.join(self.split_dir, 'velodyne')
            self.label_dir = os.path.join(self.split_dir, 'label_2')
        elif split == 'testing':
            self.num_samples = 164809
            self.split_dir = os.path.join(root_dir, 'test_root/kitti')
            self.image_dir = os.path.join(self.split_dir, 'image_2')
            self.calib_dir = os.path.join(self.split_dir, 'calib')
            self.lidar_dir = os.path.join(self.split_dir, 'velodyne')
            self.label_dir = os.path.join(self.split_dir, 'label_2')
